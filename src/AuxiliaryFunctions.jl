...
function postprocess_all(φ,Ωᶜ,rac,rho,υₕ,υₕtan,;i=0,of=1,name="plt")
  if ( i % of == 0 )
    writevtk(Ωᶜ,name*"_sur_$i",cellfields=["LS"=>φ.φ,"uₕ"=>υₕ,"uₕtan"=>υₕtan,"rac"=>rac ,"rho"=>rho],nsubcells=4)
  end
end